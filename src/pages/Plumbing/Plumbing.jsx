...
import  leakdetect from '../../assets/images/leak-detection.webp'
import  geyser from '../../assets/images/geyser-installation.jpg'
import  sanitary from '../../assets/images/sanitaryware-fitting.webp'
import  pipe from '../../assets/images/leak-repair.webp'
import  drain from '../../assets/images/sanitary-fitting.webp'


const PLUMB_HERO_IMAGE = plumbingMain;

// ── Icons ───────────────────────────────────────────────────────────────────
const PlumbIcon = ({ size = 26 }) => (
...
const PLUMB_SERVICES = [
  { num: '01.1', name: 'Tap & mixer repair',     price: '299', time: '30–45 min',  image: tap, desc: 'Drips, loose handles, low pressure or a full tap replacement.' },
  { num: '01.2', name: 'Leak detection & fixing', price: '399', time: '45–90 min',  image: leakdetect, desc: 'Concealed and surface leaks traced and sealed, walls left clean.' },
  { num: '01.3', name: 'Drain & sink unclogging', price: '349', time: '30–60 min',  image: drain, desc: 'Kitchen, basin and floor-trap blockages cleared with proper tools.' },
  { num: '01.4', name: 'Geyser installation',     price: '599', time: '60 min',     image: geyser, desc: 'Wall-mount, plumb and test any brand of storage or instant geyser.' },
  { num: '01.5', name: 'Sanitaryware fitting',    price: '699', time: '60–120 min', image: sanitary, desc: 'WC, basin, health-faucet and flush-tank install or replacement.' },
  { num: '01.6', name: 'Pipe & motor work',       price: '499', time: '60+ min',    image: pipe, desc: 'Pipe replacement, overhead-tank motor fitting and pressure pumps.' },
];
        ...
        <div className="it-hero-grid">
          <div className="it-hero-text">
            <div className="it-hero-id">
              <span className="it-badge"><PlumbIcon size={26} /></span>
              <div>
                <div className="it-cat-label">01 — Service category</div>
                <h1 className="it-hero-title">Plumbing</h1>
              </div>
            </div>

            <div className="it-tagline">
              From a dripping tap to a <span className="accent-text-main">whole-bathroom</span> re-do.
            </div>

            <p className="it-hero-desc">
              Leaks, blockages, fittings and full installations — handled by licensed
              plumbers who arrive with parts in the bag, not a quote to come back later.
            </p>
          ...
          <div className="it-hero-media">
            <div className="it-hero-img">
              {PLUMB_HERO_IMAGE ? (
                <img src={PLUMB_HERO_IMAGE} alt="Plumbing" className="it-hero-img-photo" />
              ) : (
                <>
                  <span className="it-hero-img-icon"><ImgIcon size={36} /></span>
                  <span className="it-hero-img-label">Drop a plumbing photo</span>
                </>
              )}
            </div>
            <span className="it-img-tag"><PlumbIcon size={13} /> Plumbing</span>
          </div>
        </div>
      </div>
    </header>
    ...
    <section className="it-assure bg-light">
      <div className="container it-assure-inner">
        <div style={{ maxWidth: '24ch' }}>
          <div className="it-section-label">Why book plumbing with us</div>
...
export default function Plumbing() {
  React.useEffect(() => {
    document.title = 'WowSewa — Plumbing';
  }, []);
