            ...
            <div className="container">
                ...
                <div className="auth-center-card">
                    <div className="auth-header text-center">
                        <h1>Join the <span className="accent-text-primary">Elite.</span></h1>
                        <p>Create an account for professional home maintenance.</p>
                    </div>
                    ...
                    <form className="auth-form">
                        ...
                        <button type="submit" className="btn btn-primary btn-block btn-large" onClick={signupRequest}>
                            Register Now
                        </button>
                    </form>

                    <div className="auth-footer text-center">
                        <p>Already a member? <Link to="/login" className="auth-link">Login here</Link></p>
                    </div>
                </div>
            </div>
        </div>
