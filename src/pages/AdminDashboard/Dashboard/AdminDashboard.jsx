...
import { PageHead, Card, Pill, StatTile, ClockIc, WalletIc } from "../../../ui/ui";
  ...
  return (
    <div>
      <PageHead
        ...
        sub="Real-time performance tracking & ledger audits."
      >
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className={`relative grid h-10 w-10 place-items-center rounded-lg border transition-colors duration-150 ${
              notifOpen ? "border-[#074C3A] bg-[#074C3A] text-[#D1FE17]" : "border-[#E3E5D6] bg-white text-[#5C6B60] hover:border-[#074C3A] hover:text-[#074C3A]"
            }`}
          >
            <BellIcon />
            {unread > 0 && (
              <span className="absolute -right-1.5 -top-1.5 grid h-[19px] min-w-[19px] place-items-center rounded-full bg-[#C0392B] px-1 font-mono text-[10px] font-bold text-white shadow-[0_0_0_3px_#F8FAEA]">
                {unread}
              </span>
            )}
          </button>
        ...
        <button className="flex items-center gap-2 rounded-lg border border-[#E3E5D6] bg-white px-4 py-2.5 text-[13px] font-bold text-[#074C3A] transition-colors hover:border-[#074C3A]">
          <DownloadIcon /> Export
        </button>
      </PageHead>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        {kpis.map((k) => (
          <StatTile
            key={k.label}
            label={k.label}
            value={chartsLoading ? "…" : k.value}
            icon={k.label === "Total Expense" ? WalletIc : ClockIc}
            tone={k.label === "Total Expense" ? "red" : k.up ? "pine" : "red"}
            footer={
              <span className={`flex w-fit items-center gap-1.5 text-[12px] font-bold ${k.up ? "text-[#074C3A]" : "text-[#C0392B]"}`}>
      ...
      <div className="mb-6 grid gap-5 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
            <div>
              <h3 className="m-0 font-display text-[17px] font-bold text-[#010A08]">Cash Flow Run-Rate</h3>
        ...
        <Card>
          <div className="mb-4">
            <h3 className="m-0 font-display text-[17px] font-bold text-[#010A08]">By Category</h3>
          ...
          <div className="relative mx-auto h-[200px] w-full max-w-[240px]">
            ...
            <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
              {hovered ? (
                <>
                  <span className="font-display text-[1.55rem] font-extrabold leading-none text-[#010A08]">
                ...
                <>
                  <span className="font-display text-[1.35rem] font-extrabold leading-none text-[#010A08]">{formatRs(categoryTotal)}</span>
      ...
      <div className="grid items-start gap-5 lg:grid-cols-2">
        <Card>
          <div className="mb-4 flex items-start justify-between gap-3">
            <div>
              <h3 className="m-0 font-display text-[17px] font-bold text-[#010A08]">Cash Flow Stream</h3>
                  ...
                  cashFlowData.slice(0, 6).map((flow, index) => {
                    ...
                    return (
                      <tr key={flow.id || index} className="border-b border-[#E3E5D6] transition-colors last:border-b-0 hover:bg-[#F8FAEA]">
                        <td className="px-4 py-3.5 text-[14px] font-semibold text-[#010A08]">{flow.clientName ?? flow.ClientName ?? "N/A"}</td>
                        ...
                        <td className={`px-4 py-3.5 font-mono text-[13.5px] font-bold ${isExpense ? "text-[#C0392B]" : "text-[#010A08]"}`}>
        ...
        <Card>
          <div className="mb-4 flex items-start justify-between gap-3">
            <div>
              <h3 className="m-0 font-display text-[17px] font-bold text-[#010A08]">Employee Holding Sheets</h3>
                  ...
                  holdingData.slice(0, 6).map((sheet, index) => (
                    <tr key={sheet.id || index} className="border-b border-[#E3E5D6] transition-colors last:border-b-0 hover:bg-[#F8FAEA]">
                      <td className="px-4 py-3.5">
                        ...
                        <div className="text-[14px] font-semibold text-[#010A08]">
                      ...
                      <td className="px-4 py-3.5 font-mono text-[13.5px] font-bold text-[#010A08]">{formatRs(sheet.amount ?? sheet.Amount ?? 0)}</td>
                    </tr>
                  ))
                )}
              </tbody>
